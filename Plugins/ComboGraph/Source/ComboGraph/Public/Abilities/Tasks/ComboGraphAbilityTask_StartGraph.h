...
protected:
	...
	UPROPERTY(Transient)
	UComboGraphAbilityTask_PlayMontage* RunningTask;
	...
	UPROPERTY(Transient)
	UComboGraphNodeConduit* ConduitNode;
	...
	void HandleInputConfirmed(UComboGraphNodeAnimBase* NextNode, UComboGraphEdge* Edge);
...
private:
	...
	float GetNodeMagnitudeForContainer(UComboGraphNodeAnimBase* ComboNode, const float OriginalMagnitude, FGameplayTag ContainerTag) const;
};

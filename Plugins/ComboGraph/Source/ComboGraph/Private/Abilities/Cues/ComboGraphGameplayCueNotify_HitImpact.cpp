...
void UComboGraphGameplayCueNotify_HitImpact::AsyncLoadAssets(TArray<FSoftObjectPath> AssetsToLoad, const FStreamableDelegate DoneDelegate) const
{
...
void UComboGraphGameplayCueNotify_HitImpact::AsyncLoadAsset(const FSoftObjectPath& AssetToLoad, FStreamableDelegate DoneDelegate) const
{
	AsyncLoadAssets(TArray<FSoftObjectPath>{AssetToLoad}, MoveTemp(DoneDelegate));
}

void UComboGraphGameplayCueNotify_HitImpact::OnMissingAssetsAsyncLoadComplete(TArray<FSoftObjectPath> LoadedObjects, const UObject* WorldContextObject, AActor* MyTarget, EGameplayCueEvent::Type Event, const FGameplayCueParameters Parameters)
{
	for (const FSoftObjectPath LoadedObject : LoadedObjects)
	{
		OnMissingAssetAsyncLoadComplete(LoadedObject, WorldContextObject, MyTarget, Event, Parameters);
	}
}

void UComboGraphGameplayCueNotify_HitImpact::OnMissingAssetAsyncLoadComplete(const FSoftObjectPath LoadedObject, const UObject* WorldContextObject, AActor* MyTarget, EGameplayCueEvent::Type Event, const FGameplayCueParameters Parameters)
{
	...
	CG_RUNTIME_LOG(Verbose, TEXT("UComboGraphGameplayCueNotify_HitImpact::OnMissingAssetAsyncLoadComplete - HandleSourceObject %s"), *GetNameSafe(ResolvedObject));
	HandleSourceObject(WorldContextObject, ResolvedObject, MyTarget, Event, Parameters);
}

void UComboGraphGameplayCueNotify_HitImpact::HandleSourceObject(const UObject* WorldContextObject, UObject* SourceObject, AActor* MyTarget, EGameplayCueEvent::Type Event, const FGameplayCueParameters& Parameters)
{
...
void UComboGraphGameplayCueNotify_HitImpact::GetSpawnLocationAndRotationFromParameters(AActor* MyTarget, const FGameplayCueParameters& Parameters, FVector& Location, FRotator& Rotation)
{

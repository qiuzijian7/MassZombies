...
{
	UPackage::PackageSavedEvent.AddRaw(this, &FComboGraphAssetEditor::OnPackageSaved);
}
...
void FComboGraphAssetEditor::OnPackageSaved(const FString& PackageFileName, UObject* Outer)
{
	// TODO: Needed ?
	RebuildComboGraph();
}
